...
def check_dependencies():
    ...
    required_files = [
        '/userdata/deepseek/python/voice_monitor.py',
        '/userdata/deepseek/python/traffic_prediction_main.py',
        '/userdata/deepseek/python/voice_processing_main.py',
